...
import { Aluno, Empresa, Endereco } from "../../types/User";
import {
  apagarEmpresa,
  apagarAluno,
          ...
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align="right">Instituição de Ensino</TableCell>
            ...
            <TableBody>
              {alunos.map((row) => (
                ...
                >
                  ...
                  <TableCell align="right">{row.instituicaoDeEnsino}</TableCell>
